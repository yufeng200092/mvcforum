...
define(
  ...
  function () {
    ...
    // ------------------ Start wrap
      ...
      /* http://prismjs.com/download.html?themes=prism&languages=markup+css+clike+javascript+c+csharp+cpp+ruby+css-extras+go+java+json+objectivec+php+php-extras+python+sql */
